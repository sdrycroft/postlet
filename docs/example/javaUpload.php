...
if (move_uploaded_file($_FILES['userfile']['tmp_name'], $filename))
{
    ...
    if (!isset($_SESSION["uploadedfiles"])){
	    // Register the session, and set it to an array of size 1 with this file.
	    session_register("uploadedfiles");
	    $_SESSION['uploadedfiles'] = array($filename);
    }
    else {
	    array_push($_SESSION['uploadedfiles'],$filename);
    }
    session_write_close();
	exit;
} 
